...
document.querySelector("#createPostBtn").addEventListener("click", () => {
	...
	setTimeout(() => {
		...
		document.querySelector("#link").innerHTML = "ID: " + outputID + "<br>Here is the whole link: https://mark6132014.github.io/offlineserver/online/server/community/sq?id=" + outputID;
	}, 2000);
});
document.querySelector("#viewPost").addEventListener("click", () => {
	let postInput = document.querySelector("#postID").value;
	location.assign("https://mark6132014.github.io/offlineserver/online/server/community/sq?id=" + postInput);
});