...
echo Checking for the old version of OfflineServer still uninstalled in your computer...
if EXIST "C:\inetpub\wwwroot\offlineserver-exists.txt" (
:: Get the current username
for /f "tokens=*" %%i in ('whoami') do set "CurrentUser=%%i"
...
netsh interface portproxy delete v4tov4 listenaddress=10.60.06.13 listenport=80 connectaddress=127.0.0.1 connectport=6613
timeout /t 1 /nobreak >nul
netsh interface portproxy delete v4tov4 listenaddress=10.19.0.10 listenport=80 connectaddress=127.0.0.1 connectport=1910
timeout /t 1 /nobreak >nul
netsh interface portproxy delete v4tov4 listenaddress=10.65.0.10 listenport=80 connectaddress=127.0.0.1 connectport=6510
timeout /t 1 /nobreak >nul
netsh interface portproxy delete v4tov4 listenaddress=10.52.6.10 listenport=80 connectaddress=127.0.0.1 connectport=5260
timeout /t 1 /nobreak >nul
netsh interface portproxy delete v4tov4 listenaddress=10.77.3.10 listenport=80 connectaddress=127.0.0.1 connectport=7730
timeout /t 1 /nobreak >nul
netsh advfirewall firewall delete rule name="Allow Port 6613" dir=in action=allow protocol=TCP localport=6613
timeout /t 1 /nobreak >nul
netsh advfirewall firewall delete rule name="Allow Port 1910" dir=in action=allow protocol=TCP localport=1910
timeout /t 1 /nobreak >nul
netsh advfirewall firewall delete rule name="Allow Port 6510" dir=in action=allow protocol=TCP localport=6510
timeout /t 1 /nobreak >nul
netsh advfirewall firewall delete rule name="Allow Port 5260" dir=in action=allow protocol=TCP localport=5260
timeout /t 1 /nobreak >nul
netsh advfirewall firewall delete rule name="Allow Port 7730" dir=in action=allow protocol=TCP localport=7730
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete site /site.name:google.com
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete site /site.name:apis.google.com
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete site /site.name:gstatic.com
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete site /site.name:schema.org
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete site /site.name:w3.org
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete apppool /apppool.name:google.com
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete apppool /apppool.name:apis.google.com
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete apppool /apppool.name:gstatic.com
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete apppool /apppool.name:schema.org
timeout /t 1 /nobreak >nul
%windir%\system32\inetsrv\appcmd delete apppool /apppool.name:w3.org
timeout /t 1 /nobreak >nul
echo Finished removing IIS Offline Imported Websites...
timeout /t 1 /nobreak >nul
del /q /s "%PUBLIC%\Desktop\OfflineServer.url"
echo Done
timeout /t 1 /nobreak >nul
echo The old version of OfflineServer is uninstalled...
)
else (
echo No old version of OfflineServer found.....
)
timeout /t 5 /nobreak >nul
